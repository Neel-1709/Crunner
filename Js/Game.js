class Game {
    ...
    start() {
      ...
      player1.addImage("player1", mario);
      player1.scale = 0.07;
  
      player1.addImage("blast", blastImage);
  
      player2 = createSprite(width / 2 + 100, height - 100);
      player2.addImage("player2", sonic);
      player2.scale = 0.07;
  
      player2.addImage("blast", blastImage);

      player3 = createSprite(width / 2 + 100, height - 100);
      player3.addImage("player3", hare);
      player3.scale = 0.07;
     
      player3.addImage("blast", blastImage);
      cars = [car1, car2];
